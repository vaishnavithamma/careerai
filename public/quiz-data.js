export const QUIZ_BANK = {
  ...
  Python: [
    ...
    },
    {
      ...
      options: ["Memory size", "Length of object", "Index", "Type"],
      correct: 1,
    },
    {
  ...
  React: [
    {
      ...
      options: ["Database", "Backend", "Building UI", "Operating System"],
      correct: 2,
    },
    {
    ...
    {
      q: "Props are?",
      options: ["Immutable inputs", "State variables", "Functions", "Hooks"],
      correct: 0,
    },
    {
  ...
  SQL: [
    ...
    },
    {
      ...
      options: ["Duplicate", "Null", "Unique", "Random"],
      correct: 2,
    },
    {
      q: "Which keyword sorts results?",
      options: ["GROUP BY", "ORDER BY", "SORT", "ALIGN"],
      correct: 1,
    },
    {
      q: "COUNT(*) returns?",
      options: ["Columns", "Rows", "Tables", "Indexes"],
      correct: 1,
    },
  ],
  ...
  "Machine Learning": [
    ...
    },
    {
      ...
      options: ["NumPy", "Flask", "Scikit-learn", "Bootstrap"],
      correct: 2,
    },
    {
      q: "Classification predicts?",
      options: ["Continuous values", "Categories", "Images only", "Clusters"],
      correct: 1,
    },
    {
      q: "Which metric is commonly used for classification?",
      options: ["Accuracy", "RMSE", "MAE", "MSE"],
      correct: 0,
    },
  ],
  ...
  Docker: [
    ...
    },
    {
      ...
      options: ["docker.json", "Dockerfile", "compose.yml", "docker.config"],
      correct: 1,
    },
    {
    ...
    },
    {
      ...
      options: ["docker create", "docker build", "docker run", "docker init"],
      correct: 1,
    },
  ],
  ...
  "Node.js": [
    {
      ...
      options: ["Browser only", "Server", "Database", "Compiler"],
      correct: 1,
    },
    {
      q: "Which package manager comes with Node.js?",
      options: ["Composer", "npm", "Gradle", "pip"],
      correct: 1,
    },
    {
    ...
    },
    {
      ...
      options: ["npm install", "npm create", "node install", "npm init"],
      correct: 0,
    },
  ],
  ...
  CSS: [
    ...
    },
    {
      ...
      options: ["background-color", "bg", "background-style", "fill"],
      correct: 0,
    },
    {
      q: "Flexbox is mainly used for?",
      options: ["Database", "Layout", "Animation", "Security"],
      correct: 1,
    },
    {
